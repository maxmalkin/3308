...
const logItems = [
  {
    ...
    title: "The Bear",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse eget nisl eu felis volutpat efficitur. Morbi pulvinar feugiat euismod. Mauris consequat erat nulla, ",
    platforms: ["Hulu"],
  },
  {
    id: 2,
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse eget nisl eu felis volutpat efficitur. ",
    platforms: ["Netflix"],
  },
  {
    id: 3,
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <p className="mb-8 text-sm text-gray-600">Shows that you've watched</p>
